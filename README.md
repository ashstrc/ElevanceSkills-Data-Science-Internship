...
├── README.md
│
├── Task-01-Sentiment-Analysis/
│   ├── README.md
│   ├── app.py
│   ├── requirements.txt
│   └── ...
│
├── Task-02-Medical-QA-Chatbot/
│   ├── README.md
│   ├── app.py
│   ├── parser/
│   ├── retrieval/
...
## ✅ Task 1 – AI Sentiment Analysis Assistant

A sentiment analysis application that classifies user text into **Positive**, **Negative**, or **Neutral** using a Hugging Face Transformer model.
